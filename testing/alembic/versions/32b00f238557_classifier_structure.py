...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['group_id'], [u'jsil.test_groups.id'], name='test_classifiers_group_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['classifier_id'], [u'jsil.test_classifiers.id'], name='test_run_classifications_classifier_id_fkey'),
    sa.ForeignKeyConstraint(['run_id'], [u'jsil.test_runs.id'], name='test_run_memberships_run_id_fkey'),
...
def downgrade():
    op.drop_table('test_run_classifications', schema='jsil')
    op.drop_table('test_classifiers', schema='jsil')
